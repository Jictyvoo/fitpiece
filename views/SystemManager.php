<?php
	...
	use \Fit_Piece\models\PageInformations;
	...
	if (!isset ($_SESSION ['PageCodification'])) {
		...
		$_SESSION ['PageCodification'] = new PageCodification (array_merge($pageNames, array(
			"MainPage.php",
			"../controllers/ServiceAccessController.php"
		)));
