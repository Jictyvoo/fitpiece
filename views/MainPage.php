...
<body class="profile-login">
	...
	<div class="row">
		...
		<div class="col-md-8">
			<form method="post"
				action="<?='../views/SystemManager.php?selectPage='.($_SESSION['PageCodification'] -> getChave("../controllers/ServiceAccessController.php"))?>">
				<h2 class="form-signin-heading">Login</h2>
				<input id="inputUsername" name="username" class="form-control"
					placeholder="Nome de Usuário" required autofocus /> <input
